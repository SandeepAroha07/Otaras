...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseContactPage;
...
public class ContactPage extends BaseContactPage{
	...
	public ContactPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
