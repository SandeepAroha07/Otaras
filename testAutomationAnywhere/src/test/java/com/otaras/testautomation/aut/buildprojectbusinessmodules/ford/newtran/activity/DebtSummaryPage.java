...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseDebtSummaryPage;
...
public class DebtSummaryPage extends BaseDebtSummaryPage{
	
	public DebtSummaryPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
