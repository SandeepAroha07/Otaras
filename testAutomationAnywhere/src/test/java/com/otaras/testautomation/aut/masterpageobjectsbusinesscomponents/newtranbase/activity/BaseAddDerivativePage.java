...
public class BaseAddDerivativePage  extends BasePage{
	
	   public Map<Object, Object> testData;
	
	   @FindBy(xpath = OR.AddDerivativePage_ActivitySubtype)	
	    public WebElement ActivitySubtype;
//	   @FindBy(xpath = OR.AddDerivativePage_Issuer)	
//	    public WebElement Issuer;
//	   @FindBy(xpath = OR.AddDerivativePage_LeadAdvisor)	
//	    public WebElement LeadAdvisor;
//	   @FindBy(xpath = OR.AddDerivativePage_IssueName)	
...
//	    }   
	    ...
	    public void enterDebtDetail_Derivative(Map<Object, Object> testData) 
	    {
	    	...
	    	try{
	    		...
	    		selectDropdown(OR.AddDerivativePage_ActivitySubtype,testData.get("activity").toString());
	    		
//	    		if (testData.get("activitySubtype").toString().equalsIgnoreCase("Other (please specify)"))
//	    			enterInputValue(labels.AddDerivativePage_OtherActivitySubtypeLbl,testData.get("otherActivitySubtype").toString());
	    		
	    		//selectIssuer(testData.get("issuer").toString());
	    		this.selectCombobox(OR.AddDerivativePage_Issuer, testData.get("issuer").toString());
	    		
	    		selectDropdown(OR.AddDerivativePage_PrimarySector,testData.get("primarySector").toString());
	    		selectDropdown(OR.AddDerivativePage_SecondarySector,testData.get("secondarySector").toString());
	    		//selectLeadAdvisor(testData.get("leadAdvisor").toString());
	    		this.selectCombobox(OR.AddDerivativePage_LeadAdvisor, testData.get("leadAdvisor").toString());
	    		//enterIssueName(testData.get("issueName").toString());
	    		Date d=new Date();
				String timestamp=d.toString().replace(":", "").replace(" ", "");
	      		//IssueName.sendKeys(issueName+timestamp);
	      		//testData.put("issueNameKey",testData.get("issueName").toString()+timestamp);
	      		this.enterInput(OR.AddDerivativePage_IssueName, testData.get("issueNameKey").toString());
	      		
	    		enterInput(OR.AddDerivativePage_ProjectDescription,testData.get("projectDescription").toString());
...
//	    		enterNotes(testData.get("notes").toString());
	    		...
	    		testReport.log(Status.PASS,SuccessFontColorPrefix+"enterDebtDetail_Derivative: Successful - "+SuccessFontColorSuffix);
