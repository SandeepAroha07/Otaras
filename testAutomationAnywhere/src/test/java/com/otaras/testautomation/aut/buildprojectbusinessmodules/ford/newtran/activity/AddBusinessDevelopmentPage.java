...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseAddBusinessDevelopmentPage;
...
public class AddBusinessDevelopmentPage extends BaseAddBusinessDevelopmentPage{
	
	public AddBusinessDevelopmentPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
