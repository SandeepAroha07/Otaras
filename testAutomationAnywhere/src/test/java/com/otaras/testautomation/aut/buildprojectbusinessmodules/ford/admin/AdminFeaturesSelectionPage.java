...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.adminbase.BaseAdminFeaturesSelectionPage;
...
public class AdminFeaturesSelectionPage extends BaseAdminFeaturesSelectionPage{
	
	public AdminFeaturesSelectionPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
