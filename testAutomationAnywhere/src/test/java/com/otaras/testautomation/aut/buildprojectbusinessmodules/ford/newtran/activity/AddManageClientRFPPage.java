...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseAddManageClientRFPPage;
...
public class AddManageClientRFPPage extends BaseAddManageClientRFPPage{
	
	public AddManageClientRFPPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
