...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseDebtRatingPage;
...
public class DebtRatingPage extends BaseDebtRatingPage{
	
	public DebtRatingPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
