...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.adminbase.BaseAdminUsersListPage;
...
public class AdminUsersListPage extends BaseAdminUsersListPage{
	
	public AdminUsersListPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
