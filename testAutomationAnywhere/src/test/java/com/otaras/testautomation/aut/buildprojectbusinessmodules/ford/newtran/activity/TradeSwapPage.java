...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.*;
...
public class TradeSwapPage extends BaseTradeSwapPage{
	
	public TradeSwapPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
