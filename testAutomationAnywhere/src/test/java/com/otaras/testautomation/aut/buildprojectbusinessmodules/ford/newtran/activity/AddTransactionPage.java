...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseAddTransactionPage;
...
public class AddTransactionPage extends BaseAddTransactionPage{
	
	public AddTransactionPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
