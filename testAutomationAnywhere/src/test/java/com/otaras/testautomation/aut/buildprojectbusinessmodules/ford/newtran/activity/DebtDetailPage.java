...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseDebtDetailPage;
...
public class DebtDetailPage extends BaseDebtDetailPage{
	
	public DebtDetailPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
