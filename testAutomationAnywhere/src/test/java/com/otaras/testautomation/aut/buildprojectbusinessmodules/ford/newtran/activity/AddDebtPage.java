...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseAddDebtPage;
...
public class AddDebtPage extends BaseAddDebtPage{
	
	public AddDebtPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
