...
public class BaseComplActCtrTasksPage extends BasePage{
  

    
    //---------------------------------------

    @FindBy(xpath = OR.ComplianceActionCenterTasksPage_IDLbl)	
    public WebElement IDLbl;
  
    public boolean Exists(){
      	return super.Exists(IDLbl); 
