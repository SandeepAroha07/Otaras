...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.adminbase.BaseAdminAddClientProspectPage;
...
public class AdminAddClientProspectPage extends BaseAdminAddClientProspectPage{
	
	public AdminAddClientProspectPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
