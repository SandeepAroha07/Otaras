...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseDebtDocumentsPage;
...
public class DebtDocumentsPage extends BaseDebtDocumentsPage{
	
	public DebtDocumentsPage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
