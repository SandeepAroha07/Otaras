...
import com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.newtranbase.activity.BaseAddDerivativePage;
...
public class AddDerivativePage extends BaseAddDerivativePage{
	
	public AddDerivativePage(WebDriver driver,ExtentTest testReport)
	{
		 this.driver=driver;
