package com.otaras.testautomation.aut.masterpageobjectsbusinesscomponents.toolsbase.documents;
...
public class BaseToolsDocumentsPage  extends BasePage{
	
	   public Map<Object, Object> testData;
	
	   @FindBy(xpath = OR.ToolsDocumentsPage_Category)	
