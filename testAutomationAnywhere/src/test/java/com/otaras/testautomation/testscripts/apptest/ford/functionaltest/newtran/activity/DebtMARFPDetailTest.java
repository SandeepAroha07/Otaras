...
public class DebtMARFPDetailTest {
    	...
    	static String testDataName="debt_MARFP_detail";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public DebtMARFPDetailTest(Map<Object, Object> map){
	    	this.map=map;
...
//						  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/deals/"+sObjectID+"/details");
					  ...
					  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/marfp/"+sObjectID+"/details");
					  ...
					  pages.DebtDetailPage.enterDebtDetail_MARFP(map);
