...
public class DebtManageRFPforClient1AddTest {
	    ...
	    public DebtManageRFPforClient1AddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	    	HashMap<String, String> tableColumnNames=new HashMap<>();
		  	...
		  	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Manage Client RFP1");
