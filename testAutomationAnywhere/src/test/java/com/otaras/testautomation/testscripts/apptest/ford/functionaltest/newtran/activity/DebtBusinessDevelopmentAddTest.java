...
public class DebtBusinessDevelopmentAddTest {
	    ...
	    public DebtBusinessDevelopmentAddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	    	HashMap<String, String> tableColumnNames=new HashMap<>();
	      	...
	      	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Business Development");
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
	        	...
	        	pages.AddBusinessDevelopmentPage.testData=map;                 
	        	
	        	 // Next this script cleanup
				  ...
				  pages.CommonBusinessComponentPage.LoginToApplication();
					  ...
					  pages.MenuPage.WaitForPage(pages.AddBusinessDevelopmentPage);
				
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT"); 
					  pages.AddBusinessDevelopmentPage.enterDebtDetail_BusinessDevelopment(map);
					  ...
					  pages.AddBusinessDevelopmentPage.verifyDataEntered(map);
				  ...
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT PAGE - PERFORM TEST ACTION - "+map.get("action").toString());
					  ...
					  pages.AddBusinessDevelopmentPage.WaitForPage(pages.ComplianceChecksPage);
					  ...
					  ResultLog.takeScreenShot();
					  //String  tranKeyValue = pages.AddBusinessDevelopmentPage.tranIssueNameKeyValue();
...
//					  pages.ProjectsDashboardPage.waitForElementExists("//a/mark[contains(text(),'"+tranKeyValue+"')]");
//					  //pages.ProjectsDashboardPage.ExistsCheck(driver.findElement(By.xpath("//a/*[contains(text(),'"+tranKeyValue+"')]")));
...
//					  ResultLog.takeScreenShot();
				  ...
				  ResultLog.ReportTestEvent("INFO", "##### VERIFY TRANSACTION DATA (USER DATA ENTERED IN UI) WITH DATABASE VALUES #####");
					 ...
					 // String tbl_name="actbusdevs";
		        	 // String col_name ="actIssueName" ;//"dealIssueTranName";
