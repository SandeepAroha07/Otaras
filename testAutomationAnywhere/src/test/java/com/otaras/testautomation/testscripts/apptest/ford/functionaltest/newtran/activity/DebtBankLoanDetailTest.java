...
public class DebtBankLoanDetailTest {
    	...
    	static String testDataName="debt_bankloan_detail";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public DebtBankLoanDetailTest(Map<Object, Object> map){
	    	this.map=map;
...
//						  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/deals/"+sObjectID+"/details");
					  ...
					  ResultLog.ReportTestEvent("INFO", "DEBT - BANK LOAN - DETAILS UPDATE"); 
					  pages.DebtDetailPage.clickButton(OR.DebtDetailsPage_LoanTermsLbl);
					  pages.DebtDetailPage.enterDebtDetail_BankLoanIssue(map);
