...
public class DebtBondAddTest {
    	...
    	static String testDataName="add_transaction";//"debt_bond_add";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public DebtBondAddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	      ...
	      //	recordsetTestData=ReadTestData.readTestData(testDataName);
	     	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Debt");
...
//					  pages.MenuPage.WaitForPage(pages.NewActivitySelectionPage);
				  ...
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT"); 
					  ...
					  //pages.AddDebtPage.selectCombobox("//*[contains(text(),'"+"Search by name"+"')]/parent::div//parent::div//parent::div[@role='combobox']//li[contains(text(),'Project Description')])","Project Description");
					  //pages.AddDebtPage.selectCombobox("//*[contains(text(),'"+"Search by name"+"')]/parent::div/parent::div/parent::div[@role='combobox']","Project Description");
					  //
					  //driver.findElement(By.xpath("//*[contains(text(),'"+"Search by name"+"')]/parent::div//parent::div//parent::div[@role='combobox']//li[contains(text(),'Project Description')])")).getAttribute("class");
					 
					  //working code - pages.AddDebtPage.selectCombobox(OR.AddTransactionPage_RelatedTransactionSearchByName,"Project Description");
...
//					  ResultLog.takeScreenShot();
				  ...
				  //pages.ActivityDashboardPage.WaitForPage(pages.HomePage);
