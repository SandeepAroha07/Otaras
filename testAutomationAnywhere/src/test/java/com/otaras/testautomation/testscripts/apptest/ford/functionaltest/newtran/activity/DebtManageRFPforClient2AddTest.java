...
public class DebtManageRFPforClient2AddTest {
	    ...
	    public DebtManageRFPforClient2AddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	    	HashMap<String, String> tableColumnNames=new HashMap<>();
		  	...
		  	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Manage Client RFP2");
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
	        	...
	        	pages.AddManageClientRFPPage.testData=map;                 
				  ...
				  pages.CommonBusinessComponentPage.LoginToApplication();
					  ...
					  pages.MenuPage.WaitForPage(pages.AddManageClientRFPPage);
				
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT"); 
					  pages.AddManageClientRFPPage.enterDebtDetail_ManageClientRFP(map);
				  ...
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT PAGE - PERFORM TEST ACTION - "+map.get("action").toString());
					  ...
					  //String  tranKeyValue = pages.AddManageClientRFPPage.tranIssueNameKeyValue();
...
//					  ResultLog.takeScreenShot();
				  ...
				  ResultLog.ReportTestEvent("INFO", "##### VERIFY TRANSACTION DATA (USER DATA ENTERED IN UI) WITH DATABASE VALUES #####");
					...
					//  String tbl_name="tranagencyrfps";
		        	//  String col_name ="rfpTranIssueName" ;//"dealIssueTranName";
		        	 ...
		        	 // String documentTranId=Trandocument.get("rfpTranName").toString();
...
//		        	  Document TrandocumentObj= mongodbutil.getDocumentObject("entityusers","_id", dealIssueTranAssignedTo);
		        	  ...
		        	  pages.AddManageClientRFPPage.verifyDatabase(map, Trandocument);
