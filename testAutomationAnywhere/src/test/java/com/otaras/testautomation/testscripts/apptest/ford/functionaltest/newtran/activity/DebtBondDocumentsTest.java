...
public class DebtBondDocumentsTest {
    	...
    	static String testDataName="debt_bond_documents";
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
				  ...
				  pages.CommonBusinessComponentPage.LoginToApplication();
					 ...
					 if (sActivity.equalsIgnoreCase(OR.DP_TranName_BankLoan))
					 ...
					 if (sTranName.equalsIgnoreCase("derivative"))
						 driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/derivative/"+sObjectID+"/documents");
					 if (sTranName.equalsIgnoreCase("ma-rfp"))
						 driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/marfp/"+sObjectID+"/documents");
					 if (sTranName.equalsIgnoreCase("other activity"))
						 driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/others/"+sObjectID+"/documents");
					 ...
					 map.put("TranName", sTranName);
					  ...
					  int maxAttachments=3;  //Default = 1 >> INCREASE THIS NUMBER FOR MORE THAN ONE
					  ...
					  pages.DebtDocumentsPage.enterDebtDocuments_ForAllTrans(map);
					  pages.DebtDocumentsPage.uploadDocument();
...
//						 uploadElement.sendKeys(sFilename);
					  ...
					  pages.DebtDocumentsPage.verifyDataEntered(map);
...
//					  ResultLog.takeScreenShot();
				  ...
				  ResultLog.ReportTestEvent("INFO", "DEBT BONDS DETAIL PAGE - PERFORM TEST ACTION - "+map.get("action").toString());
					...
					pages.DebtDocumentsPage.verifySpecifiedElementExistsByLabel1(map.get("actionStatus").toString());
					  }
