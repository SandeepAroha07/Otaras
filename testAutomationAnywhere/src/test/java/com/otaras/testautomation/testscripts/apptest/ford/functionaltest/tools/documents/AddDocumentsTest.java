package com.otaras.testautomation.testscripts.apptest.ford.functionaltest.tools.documents;
...
public class AddDocumentsTest {
    	...
    	static String testDataName="tools_documents";
    	
    	//String mvnParam="";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public AddDocumentsTest(LinkedHashMap<Object, Object> map){
	    	this.map=map;
...
//	        	  CommonBusinessComponentPage.f();
				  ...
				  pages.CommonBusinessComponentPage.SelectToolsDocumentsMenu();
				  
				 
					  
				  	ResultLog.ReportTestEvent("INFO", "ADD EXPENSE DETAILS"); 	
				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_Category, map.get("category").toString());
				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_SubCategory, map.get("subcategory").toString());
				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_Type, map.get("type").toString());
				  	
				  //input[@placeholder='search firm name (multi-select)']/parent::div"+"//following-sibling::span//button
				  	//pages.ToolsDocumentsPage.selectComboboxCustom1("//input[@placeholder='search firm name (multi-select)']","Florida State");
				  	
				  	
//				  	driver.findElement(By.xpath(OR.ToolsDocumentsPage_SearchContacts)).click();
//				  	driver.findElements(By.xpath("//*[@id='.*listbox_active_option']")).size();
//				  	driver.findElements(By.xpath("//*[ends-with(@id, '_listbox_active_option')]")).size();
				  	
				  	
//				  	WebElement wb1=driver.findElement(By.xpath("//div[2]/section/article/div[2]/div/div[2]/div[2]/div/div/div/div[1]/span/button"));
//				  //*[@id="main"]/section/div[2]/section/article/div[2]/div/div[4]/div[2]/div/div/div[1]/span/button
//				  	wb1.click();
//					WebElement wb11=driver.findElement(By.xpath("(//*[@id='rw_8_listbox']/li[2]"));
...
//					seriesofactions.perform();
				  	WebElement wb1;
				  	WebElement wb11;
				  	if (!map.get("searchfirmname").toString().equalsIgnoreCase("")){
				  		//pages.ToolsDocumentsPage.selectComboboxCustom1(OR.ToolsDocumentsPage_SearchFirmName,map.get("searchfirmname").toString());
				  	  	wb1=driver.findElement(By.xpath("//div[2]/div[2]/div/div/div/div[1]/span/button"));
						  	wb1.click();
							wb11=driver.findElement(By.xpath("//*[@id='rw_7_listbox_active_option']"));
							Actions builder=new Actions(driver);
							Action seriesofactions=builder
									.moveToElement(wb11)
									.click()
				  	...
				  	else if (!map.get("searchcontacts").toString().equalsIgnoreCase("")){
				  		//pages.ToolsDocumentsPage.selectComboboxCustom1(OR.ToolsDocumentsPage_SearchContacts,map.get("searchcontacts").toString());
				  		wb1=driver.findElement(By.xpath("//div[3]/div[2]/div/div/div[1]/span/button"));
					  	wb1.click();
						wb11=driver.findElement(By.xpath("//*[@id='rw_8_listbox']/li[2]"));
						Actions builder=new Actions(driver);
						Action seriesofactions=builder
								.moveToElement(wb11)
								.click()
					...
					else if (!map.get("searchtransactionname").toString().equalsIgnoreCase("")){
				  		//pages.ToolsDocumentsPage.selectComboboxCustom1(OR.ToolsDocumentsPage_SearchTransaction,map.get("searchtransactionname").toString());
						wb1=driver.findElement(By.xpath("//div[4]/div[2]/div/div/div[1]/span/button"));
					  	wb1.click();
						wb11=driver.findElement(By.xpath("//*[@id='rw_9_listbox_active_option']"));
						Actions builder=new Actions(driver);
						Action seriesofactions=builder
								.moveToElement(wb11)
								.click()
					...
					String sFilename=app.toString(); 
				  	...
				  	pages.DebtDocumentsPage.verifySpecifiedElementExistsByLabel(fileArray[0]);
				    ResultLog.ReportTestEvent("INFO", "Screenshot after performing action on transaction");
					ResultLog.takeScreenShot();
					pages.CommonBusinessComponentPage.performAction1(map.get("action").toString());
					pages.CommonBusinessComponentPage.WaitForPage(pages.DebtDocumentsPage);
				  	
				  	//ToolsDocumentsPage_SearchContacts
				  	//driver.findElement(By.xpath("//input[@placeholder='search firm name (multi-select)']/parent::div"+"//following-sibling::span//button")).click();
		    		
//				  	driver.findElement(By.xpath(OR.ToolsDocumentsPage_SearchFirmName)).click();
//					Thread.sleep(500);
//					driver.findElement(By.xpath(OR.ToolsDocumentsPage_SearchFirmName)).click();
//		    		//driver.findElement(By.xpath("(//div//ul/li)[2]")).click();
//		    		driver.findElement(By.xpath(OR.TaskPage_SearchFirmNameValue)).click();
//		    		driver.findElement(By.xpath(OR.ToolsDocumentsPage_SearchFirmName)).click();
...
//					
//					
//				  	if (j==1 && !driver.findElement(By.xpath("//tr["+1+"]/td[1]//select[@name='roleType']")).getAttribute("value").equalsIgnoreCase("pick")){
...
//				  	pages.ToolsTimeTrackerPage.enterDateCustom("//tr["+j+"]/td[2]//input[@name='date']", "10/10/203"+j,"");
