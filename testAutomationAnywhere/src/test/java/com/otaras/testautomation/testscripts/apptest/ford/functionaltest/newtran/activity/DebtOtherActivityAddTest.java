...
public class DebtOtherActivityAddTest {
	    ...
	    public DebtOtherActivityAddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	    	HashMap<String, String> tableColumnNames=new HashMap<>();
		  	...
		  	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Other Activity");
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
	        	...
	        	pages.AddOtherActivityPage.testData=map;                 
				  ...
				  pages.CommonBusinessComponentPage.LoginToApplication();
					  ...
					  pages.MenuPage.WaitForPage(pages.AddOtherActivityPage);
				

				
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT"); 
					  pages.AddOtherActivityPage.addDebt_OtherActivity(map);
...
//					  ResultLog.takeScreenShot();
				  ...
				  //pages.ActivityDashboardPage.WaitForPage(pages.HomePage);
					...
					//  pages.ActivityDashboardPage.clickProjectsTab();
					  ...
					  ResultLog.ReportTestEvent("INFO", "Screenshot after performing action on transaction");
					  ResultLog.takeScreenShot();
					  //String  tranKeyValue = pages.AddOtherActivityPage.tranIssueNameKeyValue();
...
//					  ResultLog.takeScreenShot();
				  ...
				  ResultLog.ReportTestEvent("INFO", "##### VERIFY TRANSACTION DATA (USER DATA ENTERED IN UI) WITH DATABASE VALUES #####");
					  ...
					  //String tbl_name="tranagencyothers";
		        	  //String col_name ="actTranIssueName";//"actTranIssueName" ;//"dealIssueTranName";
...
//		        	  Document TrandocumentObj= mongodbutil.getDocumentObject("entityusers","_id", dealIssueTranAssignedTo);
		        	  ...
		        	  pages.AddOtherActivityPage.verifyDatabase(map, Trandocument);
