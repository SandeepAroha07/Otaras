...
//	    public GUITest3(Map<Object, Object> map){
//	    	this.map=map;
...
////				  ImageIO.write(screenshot.getImage(), "PNG", new File("C:\\AUTOMATION\\NEW\\ashot\\anilPage.png"));
//				  
...
////				  
////						  BufferedImage ReadImageObject=ImageIO.read(new File("C:\\AUTOMATION\\NEW\\ashot\\anilPage1.png"));
////						  
...
//////						 image1=image;
////						 
////				  ImageDiff diff = new ImageDiffer().makeDiff(screenshot.getImage(), ReadImageObject);
...
//				  System.out.println("TEST STATUS: "+testReport.getStatus().toString());
