package com.otaras.testautomation.testscripts.apptest.ford.functionaltest.compliance;
...
public class AddNewControlTest {
    	...
    	static String testDataName="add_new_control";
    	
    	//String mvnParam="";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public AddNewControlTest(LinkedHashMap<Object, Object> map){
	    	this.map=map;
...
//	        	  CommonBusinessComponentPage.f();
				  ...
				  pages.CommonBusinessComponentPage.SelectComplianceActionCenterMenu();
				  pages.CommonBusinessComponentPage.Click(OR.ComplianceControlsPage_ControlsLbl);
				  pages.CommonBusinessComponentPage.WaitForPage(pages.ComplianceControlsPage);
				  pages.ComplianceControlsPage.Click(OR.ComplianceControlsPage_AddnewControl);
				  pages.ComplianceControlsPage.WaitForPage(pages.ComplianceAddEditControlPage);
				  
				  pages.ComplianceAddEditControlPage.selectDropdown(OR.ComplianceAddEditControlPage_Type, "selectValue");
				  pages.ComplianceAddEditControlPage.selectDropdown(OR.ComplianceAddEditControlPage_Target, "selectValue");
				  pages.ComplianceAddEditControlPage.selectDropdown(OR.ComplianceAddEditControlPage_Notifications, "selectValue");
				  pages.ComplianceAddEditControlPage.enterInput(OR.ComplianceAddEditControlPage_Name, "selectValue");
				 // pages.ComplianceAddEditControlPage.enterInput(OR.ComplianceAddEditControlPage_NotificationStartDate, map.get("startdate").toString());
				//  pages.ComplianceAddEditControlPage.enterInput(OR.ComplianceAddEditControlPage_NotificationEndDate, map.get("enddate").toString());
				  ResultLog.ReportTestEvent("INFO", "Screenshot after performing action on transaction");
					ResultLog.takeScreenShot();
					pages.CommonBusinessComponentPage.performAction1("Save");
					pages.CommonBusinessComponentPage.WaitForPage(pages.ComplianceAddEditControlPage);

				  
					  
//				  	ResultLog.ReportTestEvent("INFO", "ADD EXPENSE DETAILS"); 	
//				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_Category, "abc");
//				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_SubCategory, "abc");
//				  	pages.ToolsDocumentsPage.selectCombobox(OR.ToolsDocumentsPage_Type, "");
//				  	
...
//				  	pages.ToolsDocumentsPage.selectComboboxCustom1(OR.ToolsDocumentsPage_SearchFirmName,"Florida State");
//				  	
