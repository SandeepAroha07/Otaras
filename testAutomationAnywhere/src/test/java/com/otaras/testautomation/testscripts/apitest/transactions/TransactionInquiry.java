package com.otaras.testautomation.testscripts.apitest.transactions;
//package com.companyname.testautomation.testscripts.apitest.transactions;
//
...
//import com.companyname.testautomation.aut.buildprojectbusinessmodules.ford.Pages;
...
//	    public TransactionInquiry(Map<Object, Object> map){
...
//	    	
//
//	   	 //Response getRespJSON = httpRequest.
...
//	    	RestAssured.baseURI="http://mvqa1.us-east-1.elasticbeanstalk.com";
//	    	Response getRespJSON = httpRequest.
//					header("Authorization","Basic eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMEBmb3JkLmNvbSIsImlhdCI6MTUzMDk5MTIyODgyNH0.ZnydrPR6SAf1QoKKQ1evt3qMu-_gGLqyHRYI1ZwueCg").
//					header("Accept","text/plain").when().get("http://mvqa1.us-east-1.elasticbeanstalk.com/api//configs?require=picklists");
//		 String getRes = getRespJSON.getBody().asString();
//		 System.out.println("Response of:" + getRes);
//	        
...
////		                + id);
////		        if (testBrowserXML.equalsIgnoreCase("skip"))
////		        	testBrowserXML=sBrowserFromTestData;
////		        //Thread.sleep(100);
////		        extentReport=ExtentManager.CreateExtentReportExtent();
