...
public class ContactTest {
    	...
    	static String testDataName="contact";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public ContactTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
	        	  pages.ContactPage.testData=map;                 
...
//					  pages.MenuPage.clickNewMenu();
					  pages.CommonBusinessComponentPage.SelectContactsMenu();
					  pages.CommonBusinessComponentPage.waitForuntilloading(OR.loader_image);
					  pages.MenuPage.WaitForPage(pages.ContactPage);
					  
					  String  tranKeyValue="";
					  
					  tranKeyValue=pages.ContactPage.enterNewUserClientData(map);
					  
					  
					  ResultLog.ReportTestEvent("INFO", "Enter Address Data"); 
					  //pages.ContactPage.clickButton(OR.ContactPage_AddressLbl);
...
//					  pages.MenuPage.WaitForPage(pages.AddDerivativePage);
			...
			//		  pages.ContactPage.WaitForPage(pages.ContactPage);
...
//		        	  Document TrandocumentObj= mongodbutil.getDocumentObject("entityusers","_id", dealIssueTranAssignedTo);
		        	  ...
		        	  if (map.get("contactAction").toString().trim().equalsIgnoreCase("edit"))
					  {
//						  pages.ContactPage.editExistUserClientData(map);
//						  //pages.ContactPage.clickButton(OR.ContactPage_AddressLbl);
//						  //pages.AdminAddUsersPage.enterMaster_AddressData("businessAddress", "key", map.get("address").toString());
//						  pages.CommonBusinessComponentPage.performAction(map.get("action").toString());
					  }
				  ...
				  ResultLog.ReportTestEvent("INFO", "UPDATE DB FOR EXECUTION STATUS");
					  ...
					  System.out.println("##################TEST STATUS: ##################"+ testReport.getStatus().toString()+"   Document ID: "+documentID);
