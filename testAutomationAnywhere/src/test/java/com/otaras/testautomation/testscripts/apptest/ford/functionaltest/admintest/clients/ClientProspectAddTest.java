package com.otaras.testautomation.testscripts.apptest.ford.functionaltest.admintest.clients;
...
public class ClientProspectAddTest {
    	...
    	static String testDataName="newEntity_clientProspect";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public ClientProspectAddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public void testCase() throws InterruptedException, Exception{
	        ...
	        try{
	        	  pages.AddClientPage.testData=map;                 
				  ...
				  ResultLog.ReportTestEvent("INFO", "LOGIN TO APPLICATION AND NAVIGATE TO ADD DEBT PAGE"); 
					 ...
					 // pages.LoginPage.WaitForPage(pages.HomePage);
					  ...
					  pages.AdminFeaturesSelectionPage.clickElement(driver.findElement(By.xpath("//a[@href='/admin-cltprosp']")));
					  pages.AdminFeaturesSelectionPage.WaitForPage(pages.AdminClientProspectSelectionPage);
					  pages.AdminFeaturesSelectionPage.WaitForPage(pages.AdminClientProspectSelectionPage);
					  //pages.AdminClientProspectSelectionPage.clickElementByLabel("Add Client");
					
					  pages.AdminFeaturesSelectionPage.waitElementClickable(OR.AdminClientProspectMasterListPage_AddClient);
			//		  pages.AdminClientProspectSelectionPage.Click(OR.AdminClientProspectMasterListPage_AddClient);
					  
					  pages.CommonBusinessComponentPage.waitForuntilloading(OR.loader_image);
					  pages.AdminClientProspectSelectionPage.Click(OR.Admin_addclient);
					  pages.CommonBusinessComponentPage.waitForuntilloading(OR.loader_image);
					  pages.MenuPage.WaitForPage(pages.AddClientPage);
					  
					  
					//  pages.AdminFeaturesSelectionPage.waitElementClickable(OR.AddClientPage_EntityType);
					//  pages.AdminClientProspectSelectionPage.WaitForPage(pages.AdminAddClientProspectPage);
...
//					  pages.MenuPage.WaitForPage(pages.EntitySelectionPage);
				...
				//  pages.CommonBusinessComponentPage.sleep();
				  String tranKeyValue=pages.AddClientPage.enterAdminNewUserClientData(map);
				...
				ResultLog.ReportTestEvent("INFO", "Enter Business Address Data"); 
					  ...
					  driver.findElement(By.xpath(OR.Addbutton_linkcusip)).click();
					  pages.AddClientPage.enterMaster_LinkCusipData("linkCusip", "key", map.get("linkCusip").toString());
					  
					  
				//	  Thread.sleep(4000);
					  
					  driver.findElement(By.xpath(OR.Addbutton_linkObligors)).click();
					  pages.AddClientPage.enterMaster_LinkBorrowersData("linkBorrowers", "key", map.get("linkBorrowers").toString());
					  
					 // pages.AddClientPage.clickButton(OR.AddClientPage_LinkCUSIPTblLbl);
					  //driver.findElement(By.xpath("//*[contains(text(),'"+OR.AddClientPage_LinkCUSIPTblLbl+"')]/parent::div/div/div/button[contains(text(),'"+"Add"+"')]")).click();
				...
				//	  pages.CommonBusinessComponentPage.performAction(map.get("action").toString());
					  ...
					  pages.AddClientPage.WaitForPage(pages.MasterEntityClientsPropsectsPage);
				  ...
				  ResultLog.ReportTestEvent("INFO", "##### VERIFY TRANSACTION DATA (USER DATA ENTERED IN UI) WITH DATABASE VALUES #####");
		        	  ...
		        	  String col_name ="firmName";//"addresses.website";//"prevLeadAdvisor" ;//"dealIssueTranName";
		        	  //tranKeyValue="";
		        	  //String  srch_string = "TXDEALE80FA6B0A36E11E8";
		        	  //String  tranKeyValue = pages.AddClientPage.NameKeyToQueryDB();
		        	  
		        	  
					  //working code comment starts from here
		        	  ...
		        	  // working code comment ends here
...
//		        	  Document TrandocumentObj= mongodbutil.getDocumentObject("entityusers","_id", dealIssueTranAssignedTo);
		        	  ...
		        	  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/clients-propects/"+documentID+"/entity");
					  pages.ActivityDashboardPage.WaitForPage(pages.MasterEntityClientsPropsectsPage);
					  ResultLog.takeScreenShot();
