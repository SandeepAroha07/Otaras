...
public class DebtOtherActivityDetailTest {
    	...
    	static String testDataName="debt_othersactivity_detail";
    	
	    @Factory (dataProvider="dataProviderMethod")
	    public DebtOtherActivityDetailTest(Map<Object, Object> map){
	    	this.map=map;
...
//						  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/deals/"+sObjectID+"/details");
					  ...
					  driver.get(TestDataRec.TESTDATALOGINMAP.get("url")+"/others/"+sObjectID+"/details");
					  ...
					  pages.DebtDetailPage.enterDebtDetail_OthersActivity(map);
