...
public class DebtDerivativeAddTest {
	    ...
	    public DebtDerivativeAddTest(Map<Object, Object> map){
	    	this.map=map;
	    ...
	    public static Object[][] dataProviderMethod() throws Exception { 
	    	HashMap<String, String> tableColumnNames=new HashMap<>();
		  	...
		  	recordsetTestData=ReadTestData.readTestDataBySpecifiedColumnName(testDataName,"tranName","Derivative");
	        ...
	        try{
	        	...
	        	pages.AddDerivativePage.testData=map;                 
				  ...
				  ResultLog.ReportTestEvent("INFO", "ADD DEBT"); 
					  ...
					  pages.AddDerivativePage.verifyDataEntered(map);
...
//					  ResultLog.takeScreenShot();
				  ...
				  ResultLog.ReportTestEvent("INFO", "##### VERIFY TRANSACTION DATA (USER DATA ENTERED IN UI) WITH DATABASE VALUES #####");
					 ...
					 // String tbl_name="tranderivatives";
		        	 // String col_name ="actTranIssueName" ;//"dealIssueTranName";
